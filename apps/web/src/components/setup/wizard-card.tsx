...
export function WizardCard({
  ...
  const steps = connector?.wizard(brandKit, ctx) ?? [];
  const showBrandAssets = Boolean(brandKit?.assets) && steps.some((step) => step.kind === "create_account");
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        {!connector ? (
          ...
          <>
            {showBrandAssets ? <BrandAssets assets={brandKit?.assets} /> : null}
